							...
							<div class="row">
								<div class="col-md-4">
									<div class="form-group">
										...
										<input type="text" class="form-control pull-right datepicker" name="tanggal" placeholder="yyyy-mm-dd" required>
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
							...
							<div class="row">
								<div class="col-md-4">
									<div class="form-group">
										...
										<input type="text" class="form-control pull-right datepicker" name="tsemai" placeholder="yyyy-mm-dd">
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
										<label class="control_label">Tanggal Pindah Tanam</label>
										<input type="text" class="form-control pull-right datepicker" name="tpindah" placeholder="yyyy-mm-dd">
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
							...
							<div class="row">
								<div class="col-md-4">
									<div class="form-group">
										...
										<input type="text" class="form-control pull-right datepicker" name="tpemupukan1" placeholder="yyyy-mm-dd">
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
										<label class="control_label">Tanggal Pemupukan-2</label>
										<input type="text" class="form-control pull-right datepicker" name="tpemupukan2" placeholder="yyyy-mm-dd">
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
										<label class="control_label">Tanggal Pemupukan-3</label>
										<input type="text" class="form-control pull-right datepicker" name="tpemupukan3" placeholder="yyyy-mm-dd">
									</div>
								</div>
							</div>
						</div>
							...
							<div class="row">
								<div class="col-md-4">
									<div class="form-group">
										...
										<input type="text" class="form-control pull-right datepicker" name="tpanen" placeholder="yyyy-mm-dd" required>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="col-md-8">
									<div class="form-group">
										...
										<textarea class="textarea" style="width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" name="keterangan"></textarea>
									</div>
								</div>
							</div>
						</div>
